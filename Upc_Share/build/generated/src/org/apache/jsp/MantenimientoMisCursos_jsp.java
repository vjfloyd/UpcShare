...
public final class MantenimientoMisCursos_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <title>Algoritmos Avanzados (2014-02)</title>\n");
      ...
      out.write("\t\t\t\t\t\t\t<h3 class=\"panel-title\">Algoritmos Avanzados (2014-2)</h3>\n");
      out.write("\t\t\t\t\t\t\t<td><center><a href=\"\"><img src=\"img/seguir.png\" width=\"100px\" height=\"25px\"></a></center></td>\n");
      out.write("\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t    <ul>\n");
      out.write("\t\t\t\t\t\t    \t<li><a>Anuncios</a></li>\n");
      out.write("\t\t\t\t\t\t    \t<li><a>Informacion General</a></li>\n");
      out.write("\t\t\t\t\t\t    \t<li><a>Profesor del Curso</a></li>\n");
      out.write("\t\t\t\t\t\t    \t\n");
      out.write("\t\t\t\t\t\t    </ul>\n");
      out.write("\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default\">\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t    <h3 class=\"panel-title\">Archivos</h3>\n");
      out.write("\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t    <ul>\n");
      out.write("\t\t\t\t\t\t    \t<a><li>Unidad 1: Introduccion a grafos</li></a>\n");
      out.write("\t\t\t\t\t\t    \t<a><li>Unidad 2: Backtracking</li></a>\n");
      out.write("\t\t\t\t\t\t    \t<a><li>Unidad 3: Fuerza Bruta</li></a>\n");
      out.write("\t\t\t\t\t\t    \t<a data-toggle=\"modal\" data-target=\"#modal\"><li>Agregar Unidad...</li></a>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t        <h4 class=\"modal-title\">Agregar Unidad</h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t      </div>\n");
      out.write("\t\t\t\t\t\t\t\t\t      <div class=\"modal-body\">\n");
      out.write("\t\t\t\t\t\t\t\t\t        <form role=\"form\" action=\"\" class=\"form-horizontal\">\n");
      out.write("\t\t\t\t\t\t\t\t\t            <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t              <label for=\"txtTitulo\" class=\"control-label col-xs-3\">Nombre Unidad:</label>\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default\">\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t    <h3 class=\"panel-title\">Profesor del Curso</h3>\n");
      out.write("\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t\t    \t\t<div class=\"col-xs-12\">\n");
      ...
      out.write("\t\t\t\t\t\t    \t<div class=\"row\">\n");
      out.write("\t\t\t\t\t\t    \t\t<div class=\"col-xs-12\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h5 class=\"text-center\">Juan Perez Ramirez</h5>\n");
      out.write("  \t\t\t\t\t\t\t\t\t\t<center>\n");
      out.write("  \t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Editar\" class=\"btn btn-primary \" href=\"MantenimientoProfesor.html\">\n");
      out.write("\t\t\t\t\t\t    \t\t\t</center>\n");
      out.write("\t\t\t\t\t\t    \t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t    \t</div>\t\n");
      ...
      out.write("\t\t\t\t\t\t  <div class=\"panel-heading\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t    <h3 class=\"panel-title\">Anuncios\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Editar\" class=\"btn btn-primary pull-right btn-xs\">\n");
      out.write("\t\t\t\t\t\t    </h3>\n");
      out.write("\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t  <div class=\"panel-body\">\n");
      ...
      out.write("\t\t\t\t\t\t  \t\t\t<h4>\n");
      out.write("\t\t\t\t\t\t  \t\t\t\tIUASHnd<div class=\"dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-cog\"></span><strong class=\"caret\"></strong></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>\n");
      ...
      out.write("\t\t\t\t\t\t  \t\t</li>\n");
      out.write("\t\t\t\t\t\t  \t\t<li class=\"list-group-item\">\n");
      out.write("\t\t\t\t\t\t  \t\t\t<h4>IUASHnd<div class=\"dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-cog\"></span><strong class=\"caret\"></strong></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\">Eliminar Comentario</a>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t  \t\t\t<h4>\n");
      out.write("\t\t\t\t\t\t  \t\t\t\t<img src=\"img/profile.jpg\" height=\"35\" width=\"35\"> Renato Espinoza<div class=\"dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-cog\"></span><strong class=\"caret\"></strong></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\">Eliminar Comentario</a>\n");
      ...
      out.write("\t\t                                <h4>Amanna Seiar<div class=\"dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-cog\"></span><strong class=\"caret\"></strong></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\">Eliminar Comentario</a>\n");
      ...
      out.write("\t\t                                <h4>Donim Cruseia<div class=\"dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-cog\"></span><strong class=\"caret\"></strong></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\">Eliminar Comentario</a>\n");
