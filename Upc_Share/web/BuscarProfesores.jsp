														...
														<div class="col-sm-7">
																<form class="form-horizontal" role="form">
																	...
																	<div class="form-group form-group-lg">
																	    <label class="col-sm-6 control-label" for="formGroupInputLarge"> Nombre del Profesor: </label>
																	   	 <div class="col-sm-6">
																	      <input class="form-control" type="text" id="formGroupInputLarge" placeholder="Ingresar Nombre ">
																	    </div>
																	  </div>
																	  ...
																	  <div class="form-group form-group-lg">
																	    <label class="col-sm-6 control-label" for="formGroupInputLarge"> Facultad : </label>
																	   	 <div class="col-sm-6">
																	      <input class="form-control" type="text" id="formGroupInputLarge" placeholder="Ingresar Facultad ">
																	    </div>
																	  </div>
														...
														<div class="col-sm-10">
																	<table class="table table-hover table-striped">
																		...
																		<tbody>
																				<tr>
																					  <td>1</td>
																					  <td><a href="Profesores.jsp">Juan Perez Ramirez</a></td>
																					  <td>Ingeniería de Software</td>											 <td>
																					  	Algoritmos Avanzado
																				...
																				<tr>
																					  <td>2</td>
																					  <td><a href="">Pablo Caceres Saldaña</a></td>
																					  <td>Administración</td>											 <td>
																		 		...
																		 		<tr>
																					  <td>3</td>
																					  <td><a href="">Roberto Díaz Villazón</a></td>
																					  <td>Ingeniería Industrial</td>											 <td> 
																							Química
																					  </td>     
																				</tr>
																				...
																				<tr>
																					  <td>4</td>
																					  <td><a href="">Diego Matta Vega</a></td>
																					  <td>Música</td>
																					  <td> Historia de la Música
																					  </td>											     
																				</tr>	
																		</tbody>
