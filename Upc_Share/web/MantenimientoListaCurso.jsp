...
<head>
  <meta charset="utf-8">
  <title>Mantenimiento Lista Cursos</title>
					...
					<div class="panel panel-default">
						  ...
						  <div class="panel-body">
						  	<ul class="list-group">
						  		...
						  		<li class="list-group-item">
						  			<h4>Plataforma de Desarrollo .NET
						  		...
						  		<li class="list-group-item">
						  			<h4>Plataforma de Desarrollo Open Source
